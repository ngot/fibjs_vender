...
if "!BUILD_TYPE!"=="clean" (
    if "!TARGET_ARCH!"=="amd64" (
        ...
        rmdir /S/Q bin\Windows_amd64_Debug
        rmdir /S/Q bin\Windows_amd64_Release
    )

    if "!TARGET_ARCH!"=="i386" (
        rmdir /S/Q out\Windows_i386_Debug
        rmdir /S/Q out\Windows_i386_Release
        rmdir /S/Q bin\Windows_i386_Debug
        rmdir /S/Q bin\Windows_i386_Release
    )
    goto out
)
...
msbuild fibjs_vender.sln /t:Build /p:Configuration=!BUILD_TYPE!;Platform=!Platform!;PlatformToolset=v141!XP! !MT!
